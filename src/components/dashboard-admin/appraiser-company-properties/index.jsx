...
const Index = () => {
  ...
  const calculate = (searchDate, diff) => {
    const newDateObj = new Date(searchDate.requestTime);
    ...
    switch (filterQuery) {
      case "Last 7 days":
        ...
        return tempData.filter((item) => {
          const prop = item.bids.$values;
          return prop.some((value) => calculate(value.bid, 7));
        });
      case "Last 30 Days":
        ...
        return tempData.filter((item) => {
          const prop = item.bids.$values;
          return prop.some((value) => calculate(value.bid, 30));
        });
      case "Last 3 Month":
        ...
        return tempData.filter((item) => {
          const prop = item.bids.$values;
          return prop.some((value) => calculate(value.bid, 90));
        });
  ...
  useEffect(() => {
    ...
    if (searchInput === "") {
      ...
      const newProperties = tempData.filter((item) => {
        if (String(item?.city).toLowerCase() === searchInput.toLowerCase()) {
          return true;
        } else {
          return false;
        }
      ...
      const newProperties = tempData.filter((item) => {
        if (String(item?.zipCode).toLowerCase() === searchInput.toLowerCase()) {
          return true;
        } else {
          return false;
        }
                                ...
                                >
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td className="table-value">
                                        {selectedAppraiserCompany.companyName
                                          ? selectedAppraiserCompany.companyName
                                          : "N.A."}
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td className="table-value">
                                        {selectedAppraiserCompany.emailId}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td className="table-header">
                                      ...
                                      <td className="table-value">
                                        {selectedAppraiserCompany.phoneNumber}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td className="table-header">
                                      ...
                                      <td className="table-value">
                                        {selectedAppraiserCompany.cellNumber
                                          ? selectedAppraiserCompany.cellNumber
                                          : "N.A."}
                                      </td>
                                    </tr>
