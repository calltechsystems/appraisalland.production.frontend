...
export default function Exemple({
  ...
  const openBrokerViewModal = (brokerInfo) => {
    if (brokerInfo.firstName != "") {
      setSelectedBroker({ ...brokerInfo });
      setViewBrokerModal(true);
    } else {
              ...
              appraisal_status:
                isHold || isCancel ? (
                  ...
                  <div className="hover-text">
                    ...
                    <span  className={getStatusButtonClass(isBidded.appraisalStatus)}>
                      Status
                      <span className="m-1">
                        <i class="fa fa-info-circle" aria-hidden="true"></i>
                      </span>
              ...
              broker: (
                <a href="#">
                  <button
                    ...
                    onClick={() => openBrokerViewModal(brokerInfo)}
                  >
